...
double landau_pdf_plus(double x) {
    ...
    static const vector<double> pade_plus_expp6_8_numer = {
    ...
    static const vector<double> pade_plus_expp6_8_denom = {
        1.00000000000000000000e0,
    ...
    static const vector<double> pade_plus_expp8_16_numer = {
    ...
    static const vector<double> pade_plus_expp8_16_denom = {
        1.00000000000000000000e0,
    ...
    static const vector<double> pade_plus_expp16_32_numer = {
    ...
    static const vector<double> pade_plus_expp16_32_denom = {
        1.00000000000000000000e0,
    ...
    static const vector<double> pade_plus_expp32_64_numer = {
    ...
    static const vector<double> pade_plus_expp32_64_denom = {
        1.00000000000000000000e0,
    ...
    if (x <= 64) {
        ...
        double v;
        if (exponent < 8) {
            v = pade(log2(ldexp(x, -6)), pade_plus_expp6_8_numer, pade_plus_expp6_8_denom);
        }
        else if (exponent < 16) {
            v = pade(log2(ldexp(x, -8)), pade_plus_expp8_16_numer, pade_plus_expp8_16_denom);
        }
        else if (exponent < 32) {
            v = pade(log2(ldexp(x, -16)), pade_plus_expp16_32_numer, pade_plus_expp16_32_denom);
        }
        else if (exponent < 64) {
            v = pade(log2(ldexp(x, -32)), pade_plus_expp32_64_numer, pade_plus_expp32_64_denom);
        }
        else {
            v = 2 / pi;
        }
...
double landau_pdf_minus(double x) {
    static const double pi_half = pi * 0.5;
    static const double lambda_bias = 1.45158270528945486473;
...
double landau_pdf(double x) {
    return (x >= 0) ? landau_pdf_plus(x) : (x <= 0) ? landau_pdf_minus(x) : nan("");
}

double landau_cdf_plus(double x) {
    static const vector<double> pade_plus_0_1_numer = {
...
double landau_cdf_minus(double x) {
    static const double pi_half = pi * 0.5;
    static const double lambda_bias = 1.45158270528945486473;
...
double landau_cdf(double x, bool complementary = false) {
    if (x >= 0) {
        return complementary ? landau_cdf_plus(x) : 1 - landau_cdf_plus(x);
    }
    else if (x <= 0) {
        return complementary ? 1 - landau_cdf_minus(x) : landau_cdf_minus(x);
    }
    else {
        return nan("");
    }
...
double landau_quantile_upper(double x) {
    ...
    static const vector<double> pade_upper_0p25_0p375_numer = {
    ...
    static const vector<double> pade_upper_0p25_0p375_denom = {
        1.00000000000000000000e0,
    ...
    static const vector<double> pade_upper_0p375_0p5_numer = {
    ...
    static const vector<double> pade_upper_0p375_0p5_denom = {
        1.00000000000000000000e0,
    ...
    static const vector<double> pade_upper_expm32_64_numer = {
    ...
    static const vector<double> pade_upper_expm32_64_denom = {
        1.00000000000000000000e0,
    ...
    if (x >= 0.125) {
        ...
        if (x <= 0.25) {
            ...
            y = pade(x - 0.25, pade_upper_0p25_0p375_numer, pade_upper_0p25_0p375_denom);
        }
        else {
            y = pade(x - 0.375, pade_upper_0p375_0p5_numer, pade_upper_0p375_0p5_denom);
        }
        ...
        if (exponent >= -4) {
            ...
            v = pade(-log2(ldexp(x, 32)), pade_upper_expm32_64_numer, pade_upper_expm32_64_denom);
        }
        else {
            v = ldexp(1 / pi, 1);
        }
...
double landau_quantile_lower(double x) {
...
double landau_quantile(double x, bool complementary = false) {
    if (x > 0.5) {
        return landau_quantile(1 - x, !complementary);
    }

    return complementary ? landau_quantile_upper(x) : landau_quantile_lower(x);
}