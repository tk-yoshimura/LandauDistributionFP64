    ...
    public class LandauDistribution {
        ...
        private static class CDFPade {
            ...
            private static readonly (ReadOnlyCollection<double> numer, ReadOnlyCollection<double> denom) pade_minus_2_4 = new(
                new ReadOnlyCollection<double>([
                    ...
                    2.09862844420997263141e-1,
                    1.90095335991013542103e-1,
                    8.82062818606236131492e-2,
                    3.87137073062425356938e-2,
                    1.30676026370721130893e-2,
                    3.49721193604389225539e-3,
                    7.28902795938989341344e-4,
                    1.06448422842881836743e-4,
                    8.51352938742537933371e-6,
                ]),
                new ReadOnlyCollection<double>([
                    1.00000000000000000000e0,
                    4.69375635049023995347e-1,
                    5.17888845013607802920e-1,
                    2.01519191601521612565e-1,
                    1.04086311016467136567e-1,
                    3.07884166587068446295e-2,
                    9.15472670182505238639e-3,
                    1.77735359961546710967e-3,
                    2.70535933417526097589e-4,
                    2.12166718432480352743e-5,
                ])
            );
        ...
        private static class QuantilePade {
            ...
            private static readonly (ReadOnlyCollection<double> numer, ReadOnlyCollection<double> denom) pade_upper_expm4_8 = new(
                new ReadOnlyCollection<double>([
                    7.06147398566773537436e-1,
                    4.38839846004073593910e-1,
                    1.39529201745198772721e-1,
                    3.08683424854630803739e-2,
                    4.13037984880510029674e-3,
                    4.49459707066366934943e-4,
                    2.38804984998642614878e-5,
                    1.23894965144732510357e-6,
                ]),
                new ReadOnlyCollection<double>([
                    1.00000000000000000000e0,
                    6.45237771654471099684e-1,
                    2.21700195538215832483e-1,
                    4.80482768287981677690e-2,
                    6.79827535730147808043e-3,
                    6.54110481349511294258e-4,
                    4.13559836136400469261e-5,
                    1.81869060694318216456e-6,
                    5.78340493820357706047e-10,
                    5.02629139813620262466e-11,
                ])
            );

            private static readonly (ReadOnlyCollection<double> numer, ReadOnlyCollection<double> denom) pade_upper_expm8_16 = new(
                new ReadOnlyCollection<double>([
                    6.48209596014908270505e-1,
                    3.19481075461800140366e-1,
                    7.51072016886118378885e-2,
                    1.11283142424315338717e-2,
                    1.14736231595888072550e-3,
                    8.78074103692625051477e-5,
                    5.07148385644684095720e-6,
                    2.20977033196513899991e-7,
                    6.75296505943138939522e-9,
                    1.44073705798684323121e-10,
                ]),
                new ReadOnlyCollection<double>([
                    1.00000000000000000000e0,
                    5.02573909189986882673e-1,
                    1.18323278438837277613e-1,
                    1.74366978208821478158e-2,
                    1.80380424755190879988e-3,
                    1.37997608601126552139e-4,
                    7.95726897493056661527e-6,
                    3.47495157125424943767e-7,
                    1.05993467414500337074e-8,
                    2.26383517593742036491e-10,
                ])
            );
